...
for s=1:size(allsubj,2)
    ...
    sT = allsubj(s)
    subjIndx = subjCount;
    load(['Data/ERPs/group_plots_erp_DDM_bin_ST_dual8Hz_CSD_319369' num2str(sT) '_' num2str(chn)],'N2cAll','N2iAll','CPPAll','CPPrAll','RTAll','stimAll','congAll','responseAll','mediations','mediationsS','chanlocs','t','tr','subject_folder');
